...
data class GunsoutBackup(
    ...
    val mealTemplates: List<MealTemplateBackup> = emptyList(),
    val foodEntries: List<FoodEntryBackup> = emptyList(),
    val supplements: List<SupplementBackup> = emptyList(),
    val supplementLogs: List<SupplementLogBackup> = emptyList(),
