...
class ProgressionEngine {
    ...
    fun suggest(
        ...
        val compound = when (exercise.equipment) {
            ...
            com.nicholasbergesen.gunsout.data.entity.MuscleGroup.QUADS,
            com.nicholasbergesen.gunsout.data.entity.MuscleGroup.HAMSTRINGS,
            com.nicholasbergesen.gunsout.data.entity.MuscleGroup.GLUTES,
            com.nicholasbergesen.gunsout.data.entity.MuscleGroup.BACK,
            com.nicholasbergesen.gunsout.data.entity.MuscleGroup.CHEST
        )
